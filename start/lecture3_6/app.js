...
class App{
	constructor(){
		...
		this.scene.add( new THREE.HemisphereLight( 0xff0000, 0x404040 ) );
    ...
    initScene(){
        ...
        this.highlight = new THREE.Mesh( geometry, new THREE.MeshBasicMaterial( { color: 0x0000ff, side: THREE.BackSide } ) );
